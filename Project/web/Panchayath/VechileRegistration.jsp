...
<html>
    ...
    <body align="center">
        ...
        <%
            ...
            if(request.getParameter("txt_hid").equals(""))
             {
             String insQry="insert into tbl_vechile(vechile_name,vechile_number,panchayath_id)values('"+request.getParameter("txt_vname")+"','"+request.getParameter("txt_number")+"','"+session.getAttribute("pid")+"')";
             out.print(insQry);
    ...
    <table border='2' align="center">
        ...
        <tr>
            <td>Number</td>
            <td><input type="text" name="txt_number" required="required" pattern="[a-zA-Z0-9 ]+[0-9]+$" title="Should Contain Alphabets And Numbers" placeholder="Enter number" value="<%=vnum%>"></td>
        </tr>
         <tr>    
        ...
        <%
            int i=0;
            String selQry="select * from tbl_vechile where panchayath_id='"+session.getAttribute("pid")+"'";
