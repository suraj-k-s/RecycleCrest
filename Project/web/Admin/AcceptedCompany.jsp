...
<html>
    <head>
        ...
        <title>Accepted companies</title>
    </head>
    <body align="center">
        ...
        %>
        <h1 align="center"><b>ACCEPTED COMPANIES</b></h1>
  <br><br>
    <table border="2" align="center">
                ...
                <tr>
                            <%
                            int i=0;
                            String sel1="select * from tbl_company c  inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id where company_vstatus='1'";
                            ...
                            while(rs.next())
                            {
                                ...
                                <td><a href="ViewCompany.jsp?rid=<%=rs.getString("company_id")%>">  REJECT</a></td>
