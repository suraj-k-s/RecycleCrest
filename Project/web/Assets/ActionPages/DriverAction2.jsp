...
//checking if request cotains multipart data
           ...
           //to upload proof of doctor
               ...
               // {//Strinh str1="insert into tbl_user ()";//inserting file
                String InsQry = "insert into tbl_driver(driver_name,driver_address,driver_contact,driver_email,driver_gender,driver_dob,location_id,driver_photo,driver_proof,driver_password,panchayath_id,driver_doj)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + value[5] + "','" + value[6] + "','"+ photo + "','" + proof + "','" + value[9] + "','" + session.getAttribute("pid") + "',curdate())";
   ...
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Panchayath/Driver.jsp'
