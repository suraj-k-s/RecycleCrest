     ...
     <body align="center">
        ...
        <%
            if(request.getParameter("btn_save")!=null)
           {
               ...
               String selQry="select * from tbl_user where user_password='"+cpass+"' and user_id='"+session.getAttribute("uid")+"'";
              // out.print(selQry);
               ...
               if(rs.next())
               {
                   ...
                   {
               String upQry="update tbl_user set user_password='"+npass +"' where user_id='"+session.getAttribute("uid")+"'";
               //out.print(upQry);
