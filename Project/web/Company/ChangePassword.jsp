    ...
    <body align="center">
        ...
        <%
            if(request.getParameter("btn_save")!=null)
           {
               ...
               String selQry="select * from tbl_company where company_password='"+cpass+"' and company_id='"+session.getAttribute("cid")+"'";
              // out.print(selQry);
               ...
               if(rs.next())
               {
                   ...
                   {
               String upQry="update tbl_company set company_password='"+npass +"' where company_id='"+session.getAttribute("cid")+"'";
               //out.print(upQry);
