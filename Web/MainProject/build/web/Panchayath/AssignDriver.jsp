    ...
    <body align="center">
        ...
        <%
             if(request.getParameter("btn_save")!= null)
            {
               ...
               String insQry="insert into tbl_assign(request_id,driver_id,vechile_id,assigned_status,panchayath_id)values('"+request.getParameter("rdid")+"','"+request.getParameter("dropdown1")+"','"+request.getParameter("dropdown")+"','1','"+session.getAttribute("pid")+"')";
              out.print(insQry);
               if(con.executeCommand(insQry))
                {
                    ...
                    <script>
                      alert("data inserted");  
                    window.location="ViewAssigns.jsp";
                     </script>
        ...
        <table border="2" align="center">
            <tr>
                ...
                <td><select name="dropdown" required=required"">
                        ...
                        <%
            String sel="select * from tbl_vechile where panchayath_id='"+session.getAttribute("pid")+"'";
            ...
            <tr>
                ...
                <td><select name="dropdown1" required=required">
                        <option>Select</option>
                        <%
            String sel1="select * from tbl_driver where panchayath_id='"+session.getAttribute("pid")+"'";
