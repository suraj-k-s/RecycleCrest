<%-- 
    ...
    Created on : 26-Jan-2023, 08:58:09
    Author     : PSST
--%>
...
<html>
    ...
    if(request.getParameter("cid")!= null)
            {
                String delQry="delete from tbl_company where company_id='"+request.getParameter("cid")+"'";
                if(con.executeCommand(delQry))
                {
                    %>
                    <script>
                        alert("data deleted");
                        window.location="CompanyRegistration.jsp";
                    </script>
                    <%
                }
                else{
            ...
            <form method="post" enctype="multipart/form-data" action="../Assets/ActionPages/CompanyAction.jsp">
            
    <table border='2'>
        <tr>
            <td>Name</td>
            <td><input type="text" name="txt_cname" required="required" placeholder="Enter name" title="Name Allowa Only Alphabets,Spaces and First Letter Must Be Capital Letter" pattern="^[A-Z]+[a-zA-Z ]*$"/></td>
        </tr>
        <tr>
            <td>Address</td>
        ...
        <tr>
                ...
                <td><input type="file" name="txt_logo" required="required" placeholder="Upload photo"></td>
                </tr>
