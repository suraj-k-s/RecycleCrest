...
<html lang="en" >
    ...
    {
        String up ="update tbl_request set payment_status='1' where request_id='"+request.getParameter("pid")+"'";
        if(con.executeCommand(up))
        {
            %>
      <script type="text/javascript">
            alert("Payment Complated");
            setTimeout(function(){window.location.href='ViewStatus.jsp'},100);
        </script>
     <%
        }
    }
