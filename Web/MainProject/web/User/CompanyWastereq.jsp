...
<html>
    ...
    %>
        <%
            ...
            {
             String insQry = "insert into tbl_request(request_details,request_date,company_id,user_id,ewasterate_id,request_fordate,request_fortime)values('"+request.getParameter("txt_details")+"',curdate(),'"+request.getParameter("cid")+"','"+session.getAttribute("uid")+"','"+request.getParameter("dropdown2")+"','"+request.getParameter("txt_date")+"','"+request.getParameter("txt_time")+"')";
            // out.print(insQry);  
