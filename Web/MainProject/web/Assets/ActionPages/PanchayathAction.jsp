...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("txt_photo"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\PanchayathPhoto\\";//path for storing image
                            Random r = new Random();//to generate random number
                            int r_num = r.nextInt(1111) + 999;//values between this are generated

                            photo = "Panchayath " + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                    ...
                    //  {
                        //  String ext = file_name.substring(file_name.lastIndexOf("."));//means the extension is stored to variable ext
                          //setting path to store image
                        //  File proj_path = new File(config.getServletContext().getRealPath("/"));
                        //  String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\AgencyProof\\";//path for storing image
                        //  Random r = new Random();//to generate random number
                         //int r_num = r.nextInt(1111) + 999;//values between this are generated
           ...
           //to upload proof of doctor
               ...
               // {//Strinh str1="insert into tbl_user ()";//inserting file
                String InsQry = "insert into tbl_panchayath(panchayath_name,panchayath_address,panchayath_contact,panchayath_email,panchayath_photo,place_id,panchyath_password)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + photo + "','" + value[5] + "','" + value[6] + "')";
   ...
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Admin/PanchayathRegistration.jsp'
