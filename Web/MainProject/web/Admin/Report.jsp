...
<html lang="en" >
    ...
    <body>
        ...
        <h1 align="center" id="heading">Report</h1>
        <br><br>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<%
				...
				int i=0;
			String selQry = "select * from tbl_ewasterate e inner join tbl_subcategory s on s.subcategory_id=e.subcategory_id";
				...
				ResultSet rs= con.selectCommand(selQry);
                   while (rs.next()) 
				   {
					   ...
					   String selQry2 = "select count(request_id) as req from tbl_request r inner join tbl_ewasterate e on e.ewasterate_id=r.ewasterate_id inner join tbl_subcategory s on s.subcategory_id=e.subcategory_id where r.ewasterate_id='"+rs.getString("ewasterate_id")+"'";
					   
					   if(request.getParameter("btn_search")!=null)
						{
						 selQry2 = selQry2+" and request_date between '"+request.getParameter("fdate")+"' and '"+request.getParameter("tdate")+"'";
                                                        System.out.print(selQry2);
						}
            ...
            <tr>
              ...
              <td align="center"><%= rs.getString("subcat_name") %></td>
                 <td align="center"><%= rs.getString("ewaste_name") %></td>
                 <td align="center"><%=rs2.getString("req")  %></td>
              </tr>
               <%
				}
			%>
